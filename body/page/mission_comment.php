...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center pt-3 pb-3">
        <div class="fontSize-18 font-weight-bold text-success">Yêu Cầu Comment</div>
        <div class="fontSize-14 font-weight-bold">Bạn hãy comment vào <a class="text-info" target="blank" href="https://facebook.com/<?=$kq['missionFbId']?>">bài viết này</a> sau đó bấm mở khóa link</div>
    </div>
    <main class="maxWidth-1180 m-auto" role="main">
        ...
        <? if (@$_GET['error']){?>
          <div class="alert alert-secondary mt-4" role="alert">
                  ...
                  Bạn cần hoàn tất nhiệm vụ Comment vào  <a class="text-info" target="blank" href="<?=$kq['missionFbUrl']?>">bài viết này</a> để mở khóa link.<br>
                  Vui lòng thực hiện nhiệm vụ và bấm nút hoàn tất nhé
							</div>
						</div>
        <?}?>
        <div class="finishMission mt-3 text-center">
            <a href="<?=$rootURL?>/unlock/<?=$view?>"><button class="btn btn-info btn-wide">TÔI ĐÃ COMMENT </button></a>
        </div>
