...
<html lang="en">
  ...
  <div class="text-center pt-3 pb-3">
        <div class="fontSize-18 font-weight-bold text-success">Yêu Cầu Tham Gia Nhóm</div>
        <div class="fontSize-14 font-weight-bold">Bạn cần tham gia và là thành viên của <a class="text-info" target="blank" href="https://facebook.com/<?=$kq['missionFbId']?>">nhóm này</a> sau đó bấm mở khóa link</div>
    </div>
    <main class="maxWidth-1180 m-auto" role="main">

        <div id="fbIframe" class="fbIframe text-center" data="joingroup" data-mission="<?=$kq['missionFbId']?>">
        <div class="fb-group" data-href="https://www.facebook.com/groups/CongDongDigitalMarketingVNN/" data-width="360" data-show-social-context="true" data-show-metadata="false"></div>
        </div>
        ...
        <div class="finishMission mt-3 text-center">
            <a id="urlUnlock" href="#"><button class="btn btn-info btn-wide">TÔI ĐÃ THAM GIA </button></a>
        </div>
    ...
    <script src="<?=$rootURL?>/dist/js/pages/fb.js"></script>
