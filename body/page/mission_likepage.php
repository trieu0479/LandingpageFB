...
<html lang="en">
  ...
  <div class="text-center pt-3 pb-3">
        <div class="fontSize-18 font-weight-bold text-success">Yêu Cầu Like Page</div>
        <div class="fontSize-14 font-weight-bold">Bạn cần Like (Thích) <a class="text-info" target="blank" href="https://facebook.com/<?=$kq['missionFbId']?>">fanpage này</a> sau đó bấm mở khóa link</div>
    </div>
    <main class="maxWidth-1180 m-auto" role="main">

        <div class="text-center">
        <div class="fb-page" data-href="https://www.facebook.com/fff.com.vn/" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
        </div>
        ...
        <div class="finishMission mt-3 text-center">
            <a href="<?=$rootURL?>/unlock/<?=$view?>"><button class="btn btn-info btn-wide">TÔI ĐÃ LIKE </button></a>
        </div>
